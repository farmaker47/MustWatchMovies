...
public class MustWatchMoviesContract {
    ...
    public static final String PATH_TABLE_FAVORITES = "moviesFavoritesTable";
    ...
    public static final class MovieFavorites implements BaseColumns{
        ...
        public static final Uri CONTENT_URI_FAVORITES = BASE_CONTENT_URI.buildUpon().appendPath(PATH_TABLE_FAVORITES).build();

        public static final String TABLE_NAME = "moviesFavoritesTable";
